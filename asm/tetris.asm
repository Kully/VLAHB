...
// *** I want to figure out the easiest way to go from A -> B
// tetris.py

// I-piece to GRIDL
LD R[50014] SPRITE_TETRIS_I_BLOCK
LD R[50024] SPRITE_TETRIS_I_BLOCK
LD R[50034] SPRITE_TETRIS_I_BLOCK
LD R[50044] SPRITE_TETRIS_I_BLOCK

// O-piece to GRIDL
LD R[0] 0
LD R[1] 16
CALL WRITE_SPRITE_O_ROT0_TO_GRIDL

// move gridL to playfield
CALL MOVE_GRIDL_TO_PLAYFIELD
GOTO ASGDJASDGKASD_GAME_LOOP


MOVE_GRIDL_TO_PLAYFIELD:
    LD R[65530] 50000
    _GRIDL_LOOP:
        LD R[0] R[65530]
...
_GRIDL_INDEX_50000_TO_RAM_INDEX:
    ...
    LD R[1] R[0]
    LD R[2] R[0]
    REM R[0] 10  // x from gridL idx -> R[0]
    DIV R[1] 10  // y from gridL idx -> R[1]
