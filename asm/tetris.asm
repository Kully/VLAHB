...
LD R[50001] SPRITE_TETRIS_J_BLOCK
LD R[50010] SPRITE_TETRIS_T_BLOCK
LD R[50020] SPRITE_TETRIS_T_BLOCK
LD R[50030] SPRITE_TETRIS_T_BLOCK
LD R[50178] SPRITE_TETRIS_J_BLOCK
...
CALL MAP_GRIDL_CELLS_TO_TETRIS_BLOCKS_IN_PLAYFIELD



MAP_GRIDL_CELLS_TO_TETRIS_BLOCKS_IN_PLAYFIELD:
    LD R[65530] 50000
    _GRIDL_LOOP:
        LD R[0] R[65530]
